...
describe('PartnersService', () => {
  ...
  let partnerQueryDto: PartnersQueryDto;
  let partners: Partner[];

  beforeEach(async () => {
    partners = Partner.fromJson([
      {
        id: 1,
    ...
    partnerQueryDto = new PartnersQueryDto({ range: 5.13 });
  ...
  describe('read functionality', () => {
    it('should return filtered partners by range', async () => {
      partnerQueryDto.range = 5.13;
      const result = await partnersService.read(partnerQueryDto);
    ...
    it('should return all partners, in case of no range provided', async () => {
      partnerQueryDto.range = undefined;
      const result = await partnersService.read(partnerQueryDto);
            ...
            offices: [
              {
                location: 'Peterborough, UK',
                address:
                  '29 Warren Court, Hampton Hargate, Peterborough, PE7 8HA',
                coordinates: '52.5381398,-0.2713853000000199',
              },
            ],
          },
            ...
            offices: [
              {
                location: 'Trinidad',
                address:
                  '70 Caspian Cove, Westmoorings, Port of Spain, Trinidad',
                coordinates: '10.6792447,-61.56065180000002',
              },
            ],
          },
